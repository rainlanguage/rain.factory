...
/// and emits a log of its own from inside `initialize`.
///
...
/// observable — `selectors()` returns that sequence, and `Initializing` lands
/// in the log stream at the moment `initialize` runs.
