...
/// @title ICloneableFactoryV1AbiTest
/// @notice Pins the published ABI of `ICloneableFactoryV1`: the `clone`
/// selector from its literal signature, and each ABI entry as it appears in
/// the compiled artifact.
contract ICloneableFactoryV1AbiTest is Test {
    ...
    function testNewCloneAbiPinned() external view {
        assertTrue(
            vm.contains(
                LibPublishedAbi.artifactJson(vm, "ICloneableFactoryV1", "ICloneableFactoryV1"),
